        ...
        public static void SeedStoreDate(StoreContext context)
        {
            ...
            var Podzespolini = new List<Podzespol>
            {
                ...
                new Podzespol {PodzespolId=8,NazwaPodzespolu="Obudowa Zelman 100",Producent="Zelman",IsBestseller=true,DateAdded= new DateTime(2019,01,10),Price=150,ConvertFileName="8.jpg",PodzespolyId=7,Description="OPIS OBUDOWY ZALMAN 100"},
                  new Podzespol {PodzespolId=8,NazwaPodzespolu="Chłodzenie SilentiumPC",Producent="SilentiumPC",IsBestseller=false,DateAdded= new DateTime(2019,03,12),Price=149,ConvertFileName="9.jpg",PodzespolyId=5,Description="SilentiumPC Fortis 3 HE1425 v2 to potężny, jednowieżowy zestaw chłodzenia procesora zapewniający najlepszy stosunek wydajność/cena w swojej klasie. Zaprojektowany od podstaw, aby osiągnąć optymalną równowagę pomiędzy powierzchnią odprowadzania ciepła, a przepływem powietrza. Wykorzystuje pięć Φ6 mm heatpipe’ów oraz duży, aluminiowy radiator składający się z 38 fin’ów. Swój unikalny wygląd Fortis 3 HE1425 zawdzięcza czarnemu topowi oraz specjalnie zaprojektowanemu wentylatorowi."},
                    new Podzespol {PodzespolId=8,NazwaPodzespolu="Monitor AOC",Producent="AOC",IsBestseller=true,DateAdded= new DateTime(2019,01,10),Price=500,ConvertFileName="10.jpg",PodzespolyId=8,Description="Ciesz się wspaniałym obrazem Full HD Ekran umożliwia osiągnięcie rozdzielczości 1920 x 1080 pikseli. Ulepszone algorytmy przetwarzania sygnału w pełni obsługują wyższą jakość i rozdzielczość obrazu, co pozwala osiągnąć czysty obraz bez migotania, optymalną jasność i rewelacyjne kolory."},
            };
